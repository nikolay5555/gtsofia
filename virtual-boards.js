(() => {
  ...
  function shouldHideTerminalArrival() {
    // Realtime destinations from CGM are displayed exactly as received.
    // A temporary/operational destination must not be suppressed here, even
    // when it happens to match the selected stop or differs from the static
